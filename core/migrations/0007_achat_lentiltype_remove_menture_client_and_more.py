...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("core", "0006_remove_menture_progressif_progressif"),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ordonnance_return",
                    models.BooleanField(default=True, verbose_name="Ordonnance rendue"),
                ),
                (
                    "created",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "brand",
                    models.CharField(
                        blank=True, max_length=150, null=True, verbose_name="Marque"
                    ),
                ),
                (
                    "eye_choice",
                    models.CharField(
                        choices=[("OD", "OD"), ("OG", "OG")], max_length=2
                    ),
                ),
                (
                    "spher",
